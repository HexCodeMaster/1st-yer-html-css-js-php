...
<div class="success-message">
    <svg class="checkmark" xmlns="http://www.w3.org/2000/svg" width="10%" height="10%" viewBox="0 0 80 80">
        <circle class="circle-outline" cx="40" cy="40" r="35" fill="none" stroke="#5cb85c" stroke-width="5" stroke-dasharray="0,219"/>
        <path class="checkmark-path" d="M25 40l8 8 18-18" fill="none" stroke="#5cb85c" stroke-width="5" stroke-dasharray="0,100"/>
    </svg>
    <p class="success-text blink" > Success! Redirecting<span class="typing-animation"></span></p>
</div>
<script>
        setTimeout(function() {
            window.location.href = "../home_cli.php?Welcome!";
